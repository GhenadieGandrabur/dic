<div class="col-s-12 col-12 ">
  ...
  <div class="col-s-6 col-6 ">
    ...
    <form action="/search" method="GET" class="seek">
      <input type="text" name="word" id="search" class="clear" value="<?= $word ?>" placeholder="Enter first letters...">
      <button class="smallbutton" onclick="clearInput('search')">X</button>
